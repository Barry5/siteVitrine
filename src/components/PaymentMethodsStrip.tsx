...
export const PaymentMethodsStrip: React.FC = () => {
  ...
  return (
    <div className="pt-10 mt-2 border-t border-ink-line">
          ...
          <div className="flex flex-wrap gap-2">
            {localMethods.map((method, idx) => {
              ...
              return (
                <span
                  key={idx}
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-ink border border-ink-line text-xs text-slate-200"
                >
